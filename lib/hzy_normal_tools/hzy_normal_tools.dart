...
String formatDateTime({
  ...
  formatStr = _formatTimeComponent(dateTime.millisecond, formatStr, 'S', 'SSS');
...
setDataToClipboard({required String text}) async {
